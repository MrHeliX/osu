                ...
                InternalChildren = new Drawable[]
                {
                    new FillFlowContainer
                    {
                        ...
                        Children = new Drawable[]
                        {
                            ...
                            new RowDisplay("Rank:", $"#{team.Players[0].Rank:#,0}"),
                            new RowDisplay("NL" + " Rank:", $"#{team.Players[0]?.ToAPIUser()?.Statistics?.CountryRank:#,0}"),
                            new RowDisplay("NDC 2022:", team.LastYearPlacing.Value > 0 ? $"#{team.LastYearPlacing:#,0}" : "-"),
